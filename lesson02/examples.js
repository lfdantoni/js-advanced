...
const evt = new Event('look', {"bubbles": true, "cancelable": false }) // this event is fired in bubbling and cannot be canceled, so preventDefault will not work / este evento se dispara en bubbling y no puede ser cancelado
evt.data = { value: 1 }
