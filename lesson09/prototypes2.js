...
// Player.prototype.hp = 20; // prototype property / propiedad de prototipo

// const player = new Player()

// console.log(player.hp) // hp is 20, JS finds 'hp' field from player instance properties to its prototypes fields in a cascade way / hp es 20, JS busca el campo 'hp' desde las propiedades de instancia a las propiedades de sus prototipos en forma de cascada 
/*
player
  - hp -> not exists / no existe
  - prototype
    - hp -> exists here! / existe aca!
*/

// player.hp = 33; // hp is an instance property / hp es un propiedad de instancia

// console.log(player.hp)
// console.dir(player) // [[Prototype]].hp is 33, the prototype field did not change / [[Prototype]].hp is 20, el campo del prototipo no cambio

/*
player
  - hp -> exists here and is the first found / existe aca y es el primero encontrado
  - prototype
    - hp -> exists here / existe aca
*/
...
// // look at Player and playerClass prototypes on console / mirar los prototipos en la consola
...
/////////////////////////////////////////////
// Example 9 - Call super constructor
////////////////////////////////////////////
